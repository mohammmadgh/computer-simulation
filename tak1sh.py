...
# Generate the table data and calculate average waiting time, probability of waiting, fraction of idle time, fraction of busy time, and average service time
...
# Create a GUI window
root = tk.Tk()
root.title("Customer Arrival Times Table 20 C")
